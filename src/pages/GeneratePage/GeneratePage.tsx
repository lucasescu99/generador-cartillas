...
export function GeneratePage() {
  ...
  const { cartillaData, textBlocks, planOperativoBlocks, sectionOrder, reset } = useCartilla();
  ...
  useEffect(() => {
    ...
    start(cartillaData.prestadores, textBlocks, planOperativoBlocks, sectionOrder);
  }, [cartillaData, textBlocks, planOperativoBlocks, sectionOrder, start]);
